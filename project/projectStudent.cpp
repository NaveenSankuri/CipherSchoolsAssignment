...
void display_sp(int );
void display_all();
void display_sp(char []);
void delete_student(int);
void change_student(int);
void change_student(char []);
void intro();
//*************************************************************************
int main(){
    char ch;
    ...
    do
    {
        ...
        case '1':
            ...
            break;
        case '2':
            cout<<"Enter Name or Roll Number "<<endl;
            EnterAgaine:
